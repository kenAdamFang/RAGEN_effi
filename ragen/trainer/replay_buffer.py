...
class ReplayBuffer:
    ...
    """
    def __init__(self, capacity: int, sampling_batch_size: int):
        """
        Initialize the ReplayBuffer.

        Args:
            capacity: The maximum number of experiences to store in the buffer.
            sampling_batch_size: The default batch size for sampling.
        """
    ...
    def sample(self, current_batch_size: int = None) -> list[DataProto]:
        ...
        Args:
            current_batch_size: The number of experiences to sample.
                                If None, uses the default sampling_batch_size.
        ...
        if current_batch_size is None:
            current_batch_size = self.sampling_batch_size
    ...
    def __repr__(self) -> str:
        return f"ReplayBuffer(capacity={self.capacity}, sampling_batch_size={self.sampling_batch_size}, current_size={len(self._buffer)})"
